...
pub struct SteamworksStatsState {
    ...
    global_stat_i64: Vec<SteamworksGlobalStatValue<i64>>,
    last_global_stat_i64: Option<SteamworksGlobalStatValue<i64>>,
    global_stat_f64: Vec<SteamworksGlobalStatValue<f64>>,
    last_global_stat_f64: Option<SteamworksGlobalStatValue<f64>>,
    global_stat_history_i64: Vec<SteamworksGlobalStatHistory<i64>>,
    last_global_stat_history_i64: Option<SteamworksGlobalStatHistory<i64>>,
    global_stat_history_f64: Vec<SteamworksGlobalStatHistory<f64>>,
    ...
    leaderboard_score_upload_requests: Vec<SteamworksLeaderboardScoreUploadRequest>,
    last_leaderboard_score_upload_request: Option<SteamworksLeaderboardScoreUploadRequest>,
    leaderboard_score_upload_results: Vec<SteamworksLeaderboardScoreUploadResult>,
    last_leaderboard_score_upload_result: Option<SteamworksLeaderboardScoreUploadResult>,
    leaderboard_entries_download_requests: Vec<SteamworksLeaderboardEntriesDownloadRequest>,
    last_leaderboard_entries_download_request: Option<SteamworksLeaderboardEntriesDownloadRequest>,
    leaderboard_entries_download_results: Vec<SteamworksLeaderboardEntriesDownloadResult>,
